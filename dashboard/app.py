...
from src.forecasting import run_arima_pipeline, run_lstm_pipeline
...
def main():
    ...
    with tab3:
        ...
        model_type = col_f2.radio("Model Architecture", ["ARIMA", "LSTM Neural Network"])
        ...
        if st.button("Train & Forecast Pipeline"):
            ...
            with st.spinner(f"Training {model_type} on {target_ticker}... This may take a moment."):
                if model_type == "ARIMA":
                    ...
                    df_pred, metrics = run_lstm_pipeline(series, epochs=3) # Low epochs for fast web demo
